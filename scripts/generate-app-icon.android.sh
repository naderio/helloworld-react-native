...
scale=1 resolution=mdpi generate_image_bitmap

scale=1.5 resolution=hdpi generate_image_bitmap

scale=2 resolution=xhdpi generate_image_bitmap

scale=3 resolution=xxhdpi generate_image_bitmap

scale=4 resolution=xxxhdpi generate_image_bitmap
